...
if (isset($_GET['mod'])) {
    ...
    <td align="left" class="panel_text_alt2" width="50%">Level: <input type="text" name="level" value="' . htmlspecialchars($info->fields[5]) . '" size="3"> Resets: <input type="text" name="resets" value="' . htmlspecialchars($info->fields[6]) . '" size="3"> Grand Resets: <input type="text" name="grand_resets" value="' . htmlspecialchars($info->fields[7]) . '" size="3"></td>
    </tr>
    ...
    <optgroup label="---------------">
        ';
                ...
                echo '</select> Pos X: <input type="text" name="mapx" value="' . htmlspecialchars($info->fields[9]) . '" size="3"> Pos Y: <input type="text" name="mapy" value="' . htmlspecialchars($info->fields[10]) . '" size="3"></td>
    </tr>
    ...
    <optgroup label="---------------">
        ';
                ...
                echo '</select> PK Count: <input type="text" name="pkcount" value="' . htmlspecialchars($info->fields[12]) . '" size="3"></td>
    </tr>
    ...
    <td align="left" class="panel_text_alt2" width="50%">
    Str: <input type="text" name="str" value="' . htmlspecialchars($info->fields[13]) . '" size="5">
    Agi: <input type="text" name="agi" value="' . htmlspecialchars($info->fields[14]) . '" size="5">
    Vit: <input type="text" name="vit" value="' . htmlspecialchars($info->fields[15]) . '" size="5">
    Eng: <input type="text" name="eng" value="' . htmlspecialchars($info->fields[16]) . '" size="5">
    Cmd: <input type="text" name="cmd" value="' . htmlspecialchars($info->fields[17]) . '" size="5">
    </td>
    </tr>
    ...
    <td align="left" class="panel_text_alt2" width="50%"><input type="text" name="levelup" value="' . htmlspecialchars($info->fields[18]) . '">
    </td>
    </tr>
    ...
    <td align="left" class="panel_text_alt2" width="50%"><input type="text" name="zen" value="' . htmlspecialchars($info->fields[19]) . '">
    </td>
    </tr>
    ...
    <input type="submit" value="Edit Character" onclick="return ask_form(\'Are you sure?\')">&nbsp;<input type="reset" value="Reset"></td>
    </tr>
